...
export class TwitterGuestAuth implements TwitterAuth {
    ...
    async loginWithV2(
        ...
        await v2Client.login(oauthVerifier);
        // await v2Client.get('account/verify_credentials')
        // v2Client.readWrite;
        // xClient.post('statuses/update', { status: 'Hello, world!' });
        // console.log('key', key);
        // console.log('secret', secret);
        // console.log('screenName', screenName);
        this.v2Client = v2Client;
        // this.updateGuestToken();
        ...
        // try {
        //     // Log the client details before login
        //     console.log('Client before login:', v2Client);

        //     // Attempt login
        //     await delay(5000);
        //     const { client } = await v2Client.login(oauthVerifier);

        //     // Log success and details
        //     console.log('Login successful!');
        //     console.log('Client after login:', client);
        ...
        //         await delay(5000);
        //     } catch (e) {
        //         console.log('API call failed after login:', e);
        //     }
        // } catch (error) {
    ...
    isLoggedIn(): Promise<boolean> {
        console.log('is logged in', this.v2Client);
    ...
    protected async updateGuestToken() {
        ...
        console.log('guest token', newGuestToken);
